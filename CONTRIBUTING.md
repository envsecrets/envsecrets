...
We take our open source community seriously and hold ourselves and other contributors to high standards of communication. By participating and contributing to this project, you agree to uphold our [Code of Conduct](https://github.com/envsecrets/envsecrets/blob/main/CODE_OF_CONDUCT.md).

## Getting Started

Contributions are made to envsecrets repos via Issues and Pull Requests (PRs). A few general guidelines that cover both:
...
Issues should be used to report problems with envsecrets, request a new feature, or discuss potential changes before a PR is created.
...
Please have a look at our [developers guide](https://github.com/envsecrets/envsecrets/blob/main/DEVELOPERS.md) to start coding!
...
- Include documentation in the repo or on our [docs site](https://docs.envsecrets.com).
